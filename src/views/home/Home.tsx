...
import TodayCaloriesAnimated from "../../components/TodayCalories/TodayCaloriesAnimated";
...
const Home = () => {
  ...
  // estadistica del porcentaje animado
  ...
  const loadTodayFood = useCallback(async () => {
    // tambien es necesario  usar el use callback para lo mismo
    try {
